    ...
    <div className='conatiner relative background flex justify-center items-center justify-self-center w-[330px] h-[650px] m-2'>
      <div className="main h-[359px] w-[280px] relative  my-auto">
       ...
       <div className="logo">
        ...
        <Link to="/page4">
        <button  className="justify-self-center ml-2 bottom-[60px] p-12 absolute justify-center items-center align-middle"><img src="src\assets\image\startbutton.png" className='z-20 relative ' alt="play" /></button>
        </Link>
